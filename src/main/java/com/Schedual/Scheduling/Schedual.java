...
//37-@Scheduled(cron = "0 0/15 14-22 ? * SAT,SUN")


//38-@Scheduled(cron = "0 0/10 8-15 ? * MON-FRI")
...
//41-@Scheduled(cron = "0 0 12 ? * 2#1")


//42-@Scheduled(cron = "0 0/5 * 1 1-10 ?")


//43-@Scheduled(cron = "0 30 16 ? 7,8 MON-FRI")


//44-@Scheduled(cron = "0 0 0 1 1,4,7,10 ?")


//45-@Scheduled(cron = "0 0 8 1-30 * ?")


//46-@Scheduled(cron = "0 0 22-23,0-6/2 * * ?")


//47-@Scheduled(cron = "0 30 13 ? * 6")
